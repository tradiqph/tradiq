...
export function V2PreviewAnnouncementFab() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-28 z-40 mx-auto h-12 max-w-md px-4">
      <button
        type="button"
        onClick={ctx.openAnnouncement}
        aria-label="Open upcoming updates announcement"
        className={cn(
          "pointer-events-auto absolute right-4 bottom-0 flex h-12 w-12 items-center justify-center rounded-full",

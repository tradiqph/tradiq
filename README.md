...
Cloud Function `dailyBotEarnings` runs every 15 minutes (Asia/Manila) and credits 3% per bot once each 24h cycle has elapsed. Manual backfill: `npm run accrual:run` (dry-run) or `npm run accrual:confirm`.
